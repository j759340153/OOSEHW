...
public class JdbcCourseCrudPersisterTest {
  ...
  public void setUp() throws SQLException {
    ...
    sql = "CREATE TABLE IF NOT EXISTS Courses(" +
        "id INTEGER PRIMARY KEY, name VARCHAR(30) NOT NULL, url VARCHAR(100) NOT NULL );";
    st.execute(sql);
  ...
  public void addingCourseWithNullNameFails() {
    ...
    //   you must make changes so that SQLite would not 
    //   accept null values for course name.
